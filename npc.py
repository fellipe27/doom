...
class CacoDemonNpc(Npc):
    def __init__(self, game, path='resources/sprites/npc/caco-demon/0.png', pos=(10.5, 6.5), scale=0.7, shift=0.27, animation_time=250):
        super().__init__(game, path, pos, scale, shift, animation_time)
        self.attack_dist = 1
        self.health = 150
...
class CyberDemonNpc(Npc):
    def __init__(self, game, path='resources/sprites/npc/cyber-demon/0.png', pos=(11.5, 6), scale=1, shift=0.04, animation_time=210):
        super().__init__(game, path, pos, scale, shift, animation_time)
        self.attack_dist = 6
        self.health = 200
